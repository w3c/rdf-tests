...
when :html
  ...
  validate(RDF::RDFa::Reader.new(html, base_uri: "http://www.w3.org/2009/sparql/docs/tests/data-sparql11/http-rdf-update/manifest.ttl", validate: validate)) if validate
  output.write(html)
when :jsonld
